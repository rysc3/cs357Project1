...
/* package Anagrams-0.1.0.0 */
#ifndef VERSION_Anagrams
#define VERSION_Anagrams "0.1.0.0"
#endif /* VERSION_Anagrams */
#ifndef MIN_VERSION_Anagrams
#define MIN_VERSION_Anagrams(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Anagrams */
...
#define CURRENT_COMPONENT_ID "Anagrams-0.1.0.0-inplace-Anagrams"
